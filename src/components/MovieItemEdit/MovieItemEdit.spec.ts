...
describe('MovieItemEdit', () => {
  it('should remove a movie', () => {
    ...
    /**
     * obligé de laisser la page vide car la variable est générée dynamiquement
     * dans le component et ne peut donc être générée dans le cli
    */
    expect(spy).toHaveBeenCalledWith(
      'movies/removeMovie',
      { movie: { id: 1, name: 'Movie1', iswatch: true, image: '',
      popularity: 2.06 },
      page: '',
    });
  });
